...
import type { Listing as RelatedListing } from '@/lib/api/listings'
import type { Listing as LegacyListing, Seller } from '@/lib/types/listing'
import {
  ArrowLeft,
  BadgeCheck,
  CalendarDays,
      ...
      <div className="mt-6 grid gap-8 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,0.78fr)_26rem] xl:items-start">
        ...
        <section className="min-w-0">
          ...
          <section className="mt-7">
            ...
            <p className="mt-1 leading-8 text-[#485249]">{t('dailyUse')}</p>
          </section>
