              ...
              {goals.map(({ Icon, titleKey, bodyKey }, index) => (
                <article
                  ...
                  className={`px-5 py-4 text-center ${
                    index < goals.length - 1 ? "md:border-r md:border-[#dce5db]" : ""
                  }`}
                >
                  <Icon className="mx-auto size-12 text-primary" strokeWidth={1.7} />
                  <h3 className="mt-4 font-black text-[#18251a]">{t(titleKey)}</h3>
          ...
          <section className="mt-8 rounded-xl border border-[#dfe5df] bg-[#f1f6ef] p-6">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-4">
              {approach.map(({ Icon, titleKey, bodyKey }) => (
                ...
                >
                  <Icon className="mx-auto size-10 text-primary" strokeWidth={1.7} />
                  <h3 className="mt-4 font-black text-[#18251a]">{t(titleKey)}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-[#58645b]">
                    {t(bodyKey)}
                  </p>
